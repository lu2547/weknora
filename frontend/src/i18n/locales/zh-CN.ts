export default {
  ...
  knowledgeBase: {
    ...
    tagMoveAction: "移动",
    tagMoveTitle: "移动标签",
    tagMoveDesc: "请选择新的父标签（选择根节点将移到顶层）",
    tagMoveSuccess: "标签已移动",
    tagRootNode: "根节点",
    tagParentLabel: "父标签",
    tagParentPlaceholder: "请选择父标签（不选则为根标签）",
    tagAddChildAction: "新建子标签",
    tagIncludeSubtree: "包含子标签",
    tagPathLabel: "路径",
  ...
  knowledgeEditor: {
    ...
    basic: {
      ...
      categoryPersonal: "个人",
      categoryPublic: "公共",
      categoryEnterprise: "企业",
      categoryDescription: "个人/公共库共享同一 Milvus collection；企业库独立 collection。创建后不允许修改。",
      nameLabel: "知识库名称",
  ...
  agentEditor: {
    ...
    tools: {
      ...
      selectDocuments: "选文档",
      selectDocumentsDesc: "按主题/部门/时间/文件名/类型筛选候选文档，不返回分片正文",
      grepChunks: "关键词搜索",
