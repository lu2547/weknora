export default {
  ...
  knowledgeBase: {
    ...
    tagMoveAction: "이동",
    tagMoveTitle: "태그 이동",
    tagMoveDesc: "새 상위 태그를 선택하세요(루트를 선택하면 최상위로 이동)",
    tagMoveSuccess: "태그가 이동되었습니다",
    tagRootNode: "루트",
    tagParentLabel: "상위 태그",
    tagParentPlaceholder: "상위 태그를 선택하세요(비우면 루트 태그)",
    tagAddChildAction: "하위 태그 추가",
    tagIncludeSubtree: "하위 태그 포함",
    tagPathLabel: "경로",
  ...
  agentEditor: {
    ...
    tools: {
      ...
      selectDocuments: '문서 선별',
      selectDocumentsDesc: '주제/부서/시간/파일명/유형으로 후보 문서 필터링, 분할 본문은 반환하지 않음',
      grepChunks: '키워드 검색',
