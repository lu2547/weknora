export default {
  ...
  knowledgeBase: {
    ...
    tagMoveAction: 'Переместить',
    tagMoveTitle: 'Переместить тег',
    tagMoveDesc: 'Выберите новый родительский тег (выберите корень, чтобы переместить на верхний уровень)',
    tagMoveSuccess: 'Тег перемещён',
    tagRootNode: 'Корень',
    tagParentLabel: 'Родительский тег',
    tagParentPlaceholder: 'Выберите родительский тег (оставьте пустым для корневого тега)',
    tagAddChildAction: 'Добавить дочерний тег',
    tagIncludeSubtree: 'Включая дочерние теги',
    tagPathLabel: 'Путь',
...
/example\.(net|org)/`,
  ...
  agentStream: {
    tools: {
      ...
      selectDocuments: 'Выбор документов',
      grepChunks: 'Поиск по текстовому шаблону',
      webSearch: 'Веб-поиск',
  ...
  agentEditor: {
    ...
    tools: {
      ...
      selectDocuments: 'Выбор документов',
      selectDocumentsDesc: 'Фильтрация кандидатов по теме/отделу/времени/имени файла/типу. Не возвращает текст фрагментов.',
