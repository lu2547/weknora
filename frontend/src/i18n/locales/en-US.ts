export default {
  ...
  knowledgeBase: {
    ...
    tagMoveAction: 'Move',
    tagMoveTitle: 'Move tag',
    tagMoveDesc: 'Pick a new parent tag (choose root to move to the top level)',
    tagMoveSuccess: 'Tag moved',
    tagRootNode: 'Root',
    tagParentLabel: 'Parent tag',
    tagParentPlaceholder: 'Select a parent tag (leave empty for root)',
    tagAddChildAction: 'Add child tag',
    tagIncludeSubtree: 'Include sub-tags',
    tagPathLabel: 'Path',
  ...
  knowledgeEditor: {
    ...
    basic: {
      ...
      categoryLabel: 'Knowledge Base Category',
      categoryPersonal: 'Personal',
      categoryPublic: 'Public',
      categoryEnterprise: 'Enterprise',
      categoryDescription: 'Personal/Public KBs share one Milvus collection; Enterprise KBs use a dedicated collection. Cannot be changed after creation.',
...
\
  ...
  agentEditor: {
    ...
    tools: {
      ...
      selectDocuments: 'Select Documents',
      selectDocumentsDesc: 'Filter candidate documents by topic/department/time/filename/type. Returns no chunk content.',
