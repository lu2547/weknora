        ...
        >
          <template #content>
            <ContentPopup 
              ...
              :knowledge-title="result.knowledge_title"
...
const handlePreview = (info: { knowledgeId: string; knowledgeTitle?: string; knowledgeBaseName?: string; tagName?: string }) => {
  previewDrawer.value = {
    visible: true,
    knowledgeId: info.knowledgeId,
    knowledgeTitle: info.knowledgeTitle,
  };
};
